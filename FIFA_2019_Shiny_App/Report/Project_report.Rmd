...
#Main Review Football Players & Clubs
...
# Our observations
We have noticed some differences between players
The biggest difference is related to the correlation between the position in the pitch and the player salary.
So, the player who plays in the forward position has a higer value compared to a defensive player.

Another interesting fact is about the league values and the distribution of valuable players in it.
Premier League (England) is the league with the highest value and compared to other leagues there are more teams with high range valuable players.

Taking a look to the other 4 leagues where there is only one or two dominant teams and their values consist of at least 20% of the whole league we can say the competiotion is higher in England.
We can mention here Bayern in Germany with 17% and Paris Saint & Germaint with almost 20%

Let's continue with our observations and this time we concentrate on league nationnality diversity.
Premier league is the most foreign players friendly where almost 70% of the players are not international and on the opposite side we have Spain La liga where only 42% of the players are international.

Is this a indicator that spanish football style is not easy to adapt or the football market is not easy for players who want's to get in.

Use this application to understand more about the wonderful wold of football.
